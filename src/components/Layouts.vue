<template>
  <!-- Home -->
  <header
    class="bg-amber-400 shadow-md fixed w-full px-10 sm:px-12 py-4 top-0 z-10"
  >
    <p class="text-white">Appointmate</p>
  </header>
  <main
    class="container grid grid-cols-1 sm:grid-cols-12 mx-auto bg-white justify-stretch px-10 gap-10 overflow-hidden mt-14 py-10"
  >
    <main
      class="sm:col-start-1 sm:col-end-8 flex flex-col bg-white grow-0 gap-2"
    >
      <header class="text-2xl">At a Glance</header>
      <div class="flex flex-col gap-4">
        ...
        <footer class="text-right text-orange-600 font-medium underline">
          <a href="#">See all...</a>
        </footer>
      </div>
    </main>
  ...
  <!-- Login -->
  <main
    class="container grid grid-cols-1 sm:grid-cols-12 mx-auto bg-white justify-stretch px-10 gap-10 overflow-hidden mt-10"
  >
    <section
      class="lg:col-start-8 lg:col-end-12 sm:col-start-3 sm:col-end-11 flex flex-col bg-white grow-0 gap-6 rounded-3xl p-10 shadow-md"
    >
      <section class="flex flex-col gap-2">
        <h1 class="text-4xl">Log in</h1>
        <p>New here? <a href="#" class="underline">Create an account</a></p>
      </section>
      <form action="#" class="flex flex-col gap-3">
        ...
        <button
          class="mt-2 p-2 text-sm bg-amber-400 rounded-lg text-white font-medium self-start px-6"
          type="submit"
        >
          Log in
        </button>
  ...
  <!-- Profile -->
  <main
    class="container flex flex-col-reverse sm:grid sm:grid-cols-12 mx-auto bg-white justify-stretch px-10 box-border gap-10 overflow-hidden mt-10 py-8"
  >
    <main class="sm:col-start-1 sm:col-end-8">
      <nav
        class="text-sm font-medium text-center text-black border-b border-transparent shadow-md sticky mb-2 top-0 bg-white"
      >
        <ul class="flex -mb-px">
          <li class="w-full">
            <a
    ...
    <aside
      class="sm:col-start-8 sm:col-end-13 bg-white shrink-0 flex flex-col gap-2 sm:h-[inherit]"
    >
  ...
  <section
    class="w-full h-80 bg-cover bg-center mt-14"
    style="background-image: url('../public/img/sample.jpg')"
  ></section>
  <main
    class="container grid grid-cols-1 sm:grid-cols-12 mx-auto bg-white justify-stretch px-10 gap-10 py-10 overflow-hidden"
  >
    <main
      class="sm:col-start-1 sm:col-end-8 flex flex-col bg-white grow-0 gap-2"
    >
      ...
      <form action="#" class="flex flex-col gap-4">
        ...
        <footer class="flex flex-row-reverse gap-4">
          <button
            class="mt-2 py-2 px-6 text-sm bg-amber-400 rounded-lg text-white font-medium"
            type="submit"
          >
            Create/Update
          </button>
